  ...
  <div class="notification-channels-view">
    ...
    <div class="page-header">
      <div class="header-left">
        ...
        <span class="header-title">通知渠道管理</span>
      </div>
      ...
      >
        ...
        <el-table-column label="类型" width="120">
          <template #default="{ row }">
            <el-tag :type="getChannelTypeTagType(row.type)" size="small">
...
import { Refresh, Plus, Message, Bell, Link, Promotion } from '@element-plus/icons-vue'
