...
describe('AuditLogger', () => {
  ...
  it('should query logs by action type', async () => {
    await auditLogger.log({ action: 'config_change', actor: 'user', details: { trigger: 'manual' } });
    await auditLogger.log({ action: 'alert_trigger', actor: 'system', details: { trigger: 'auto' } });
